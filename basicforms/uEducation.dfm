    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1085#1072#1095#1072#1083#1072' '#1086#1073#1091#1095#1077#1085#1080#1103
          DataBinding.FieldName = 'start_educ_date'
          Width = 94
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'end_educ_date'
          Width = 103
        end
        object grBaseDBTableViewColumn4: TcxGridDBColumn
          Caption = #1057#1090#1077#1087#1077#1085#1100' '#1086#1073#1088#1072#1079#1086#1074#1072#1085#1080#1103
          DataBinding.FieldName = 'educ_name'
          Width = 112
        end
        object grBaseDBTableViewColumn5: TcxGridDBColumn
          Caption = #1055#1088#1086#1092#1077#1089#1089#1080#1103
          DataBinding.FieldName = 'name_profession'
          Width = 91
        end
