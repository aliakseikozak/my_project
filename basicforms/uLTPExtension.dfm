inherited fmLTPExtension: TfmLTPExtension
  Caption = 'fmLTPExtension'
  ClientWidth = 1001
  ExplicitWidth = 1017
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1087#1088#1086#1076#1083#1077#1085#1080#1103
          DataBinding.FieldName = 'extension_date'
          Width = 115
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          Caption = #1048#1085#1092#1086#1088#1084#1072#1094#1080#1103' '#1086' '#1088#1077#1096#1077#1085#1080#1080' '#1089#1091#1076#1072
          DataBinding.FieldName = 'court_decision'
          Width = 221
        end
