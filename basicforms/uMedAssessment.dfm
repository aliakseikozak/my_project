inherited fmMedAssessment: TfmMedAssessment
    ...
    inherited grBase: TcxGrid
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          Caption = #1057#1088#1086#1082' '#1086#1094#1077#1085#1082#1080' ('#1076#1083#1103' '#1084#1077#1076#1080#1082#1086'-'#1089#1086#1094#1080#1072#1083#1100#1085#1086#1075#1086' '#1082#1088#1080#1090#1077#1088#1080#1103')'
          DataBinding.FieldName = 'name_rehabilitation'
          Options.AutoWidthSizable = False
          Width = 198
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1086#1082#1086#1085#1095#1072#1085#1080#1103' '#1088#1077#1072#1073#1080#1083#1080#1090#1072#1094#1080#1080
          DataBinding.FieldName = 'rehabilitation_end_date'
          Options.AutoWidthSizable = False
          Width = 126
        end
