inherited fmLTPPreventive: TfmLTPPreventive
  Caption = 'fmLTPPreventive'
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          Caption = #1055#1088#1086#1090#1086#1082#1086#1083' '#1087#1086#1089#1090#1072#1085#1086#1074#1082#1080' ('#1085#1086#1084#1077#1088')'
          DataBinding.FieldName = 'protocol_begin_number'
          Width = 131
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          Caption = #1055#1088#1086#1090#1086#1082#1086#1083' '#1087#1086#1089#1090#1072#1085#1086#1074#1082#1080' ('#1076#1072#1090#1072')'
          DataBinding.FieldName = 'protocol_begin_date'
          Width = 128
        end
        object grBaseDBTableViewColumn4: TcxGridDBColumn
          Caption = #1055#1088#1086#1090#1086#1082#1086#1083' '#1089#1085#1103#1090#1080#1103' ('#1085#1086#1084#1077#1088')'
          DataBinding.FieldName = 'protocol_end_number'
          Width = 117
        end
        object grBaseDBTableViewColumn5: TcxGridDBColumn
          Caption = #1055#1088#1086#1090#1086#1082#1086#1083' '#1089#1085#1103#1090#1080#1103' ('#1076#1072#1090#1072')'
          DataBinding.FieldName = 'protocol_end_date'
          Width = 124
        end
        object grBaseDBTableViewColumn6: TcxGridDBColumn
          Caption = #1050#1072#1090#1077#1075#1086#1088#1080#1103' '#1087#1088#1086#1092#1091#1095#1077#1090#1072
          DataBinding.FieldName = 'category_preventive_name'
          Width = 176
        end
