inherited fmMedinspector: TfmMedinspector
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1091#1089#1090#1072#1085#1086#1074#1083#1077#1085#1080#1103' '#1085#1072#1073#1083#1102#1076#1077#1085#1080#1103
        ...
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'examenation_date'
          Width = 177
        end
        object grBaseDBTableViewColumn4: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'dependence_name'
          Width = 111
        end
        object grBaseDBTableViewColumn5: TcxGridDBColumn
          Caption = #1044#1086#1082#1090#1086#1088
          DataBinding.FieldName = 'doctor_id'
          Width = 123
        end
        object grBaseDBTableViewColumn7: TcxGridDBColumn
          Caption = #1043#1076#1077' '#1085#1072#1073#1083#1102#1076#1072#1077#1090#1089#1103
