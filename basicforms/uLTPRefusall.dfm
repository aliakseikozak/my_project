inherited fmLTPRefusall: TfmLTPRefusall
  Caption = 'fmLTPRefusall'
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'refusal_date'
          Width = 99
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          Caption = #1055#1088#1080#1095#1080#1085#1072' '#1086#1090#1082#1072#1079#1072
          DataBinding.FieldName = 'refusal_reason_name'
          Width = 111
        end
        object grBaseDBTableViewColumn4: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1085#1072#1087#1088#1072#1074#1083#1077#1085#1080#1103' '#1091#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1074' '#1089#1091#1076
          DataBinding.FieldName = 'court_notification_date'
          Width = 146
        end
