inherited fmLTPWork: TfmLTPWork
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'work_LTP_begin_date'
          Width = 117
        end
        ...
        object grBaseDBTableViewColumn5: TcxGridDBColumn
          Caption = #1054#1094#1077#1085#1082#1072' '#1076#1077#1103#1090#1077#1083#1100#1085#1086#1089#1090#1080
          DataBinding.FieldName = 'work_LTP_result'
          Width = 103
        end
