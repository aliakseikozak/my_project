inherited fmLTPInformation: TfmLTPInformation
  Caption = #1051#1080#1095#1085#1086#1077' '#1076#1077#1083#1086'. '#1051#1058#1055' '
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1085#1072#1087#1088#1072#1074#1083#1077#1085#1080#1103' '#1074' '#1051#1058#1055
          DataBinding.FieldName = 'ltp_referral_date'
          Options.AutoWidthSizable = False
          Width = 106
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          Caption = #1044#1072#1090#1072' '#1087#1086#1089#1090#1091#1087#1083#1077#1085#1080#1103' '#1074' '#1051#1058#1055
          DataBinding.FieldName = 'ltp_begin_date'
          Options.AutoWidthSizable = False
          Width = 107
        end
        object grBaseDBTableViewColumn4: TcxGridDBColumn
          Caption = #1051#1058#1055' '#1087#1088#1080' '#1087#1086#1089#1090#1091#1087#1083#1077#1085#1080#1080
          DataBinding.FieldName = 'begin_ltp_name'
          Options.AutoWidthSizable = False
          Width = 100
        end
        object grBaseDBTableViewColumn5: TcxGridDBColumn
          Caption = #1054#1090#1088#1103#1076
          DataBinding.FieldName = 'ltp_group'
          Options.AutoWidthSizable = False
          Width = 100
        end
