...
begin
  ...
  FreeAndNil(dbBase);
  dbBase := DataSetQuery('grinformation_field_oz_get', [Resource.sessionInfo.token_id, '1', Columns, Params, Operations], GetFieldsArray(), true);
...
begin
  InitForm;
  gNameForm := 'fmOZ';
  dbBase := DataSetQuery('grinformation_field_oz_get', [Resource.sessionInfo.token_id, '1', 'bmf.id', '-1', '='], GetFieldsArray(), true);
  dsBase.DataSet := dbBase.DataSet;
  SetControlFormat;
end;
