inherited fmLtptraining: TfmLtptraining
  Caption = 'fmLtptraining'
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited grBase: TcxGrid
      ...
      inherited grBaseDBTableView: TcxGridDBTableView
        ...
        object grBaseDBTableViewColumn2: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'specialization_name'
          Width = 111
        end
        object grBaseDBTableViewColumn3: TcxGridDBColumn
          Caption = #1059#1095#1088#1077#1078#1076#1077#1085#1080#1103' '#1086#1073#1088#1072#1079#1086#1074#1072#1085#1080#1103
          DataBinding.FieldName = 'stady_palace_name'
          Width = 323
        end
