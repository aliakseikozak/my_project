...
{       Associative Arrays Unit (variable version)      }
...
uses
  SysUtils{$IFDEF ABOVE_D5}, Variants{$ENDIF}, System.Variants;
...
//IID_IAbstractArray = '{2761F496-934F-4330-85FD-139571748767}';
...
type
  ...
  IAbstractArray = interface
    ['{2761F496-934F-4330-85FD-139571748767}']
  ...
  IVariantArray = interface(IAbstractArray)
  ...
  IBooleanArray = interface(IAbstractArray)
  ...
  IIntegerArray = interface(IAbstractArray)
  ...
  IInt64Array = interface(IAbstractArray)
  ...
  IFloatArray = interface(IAbstractArray)
  ...
  IDateTimeArray = interface(IAbstractArray)
  ...
  IStringArray = interface(IAbstractArray)
  ...
  IPointerArray = interface(IAbstractArray)
  ...
  IObjectArray = interface(IAbstractArray)
  ...
  IClassArray = interface(IAbstractArray)
  ...
  IMultiArray = interface(IAbstractArray)
    ...
    function GetInstance: TMultiArray;
  ...
  //
    ...
    property Instance: TMultiArray read GetInstance;
  ...
  TVariantArray = class(TInterfacedObject)
  private
    FBof: Boolean;
    FCapacity: Integer;
  ...
  //
    ...
    procedure CreateItem(var pItem: PVarItem); virtual;
    procedure FreeItem(var pItem: PVarItem); virtual;
    procedure Grow; virtual;
    procedure QuickSort(L, R: Integer);
  public
    constructor Create; overload; virtual;
    constructor Create(CustomCompare: TVariantCompare); overload; virtual;
    destructor Destroy; override;
    function Exchange(const Key1, Key2: Variant): Boolean; virtual;
    function Exist(const Key: Variant): Boolean;
    function FindKey(const Key: Variant; var Index: Integer): Boolean;
    function FindValue(const Value: Variant; var Index: Integer): Boolean;
    function Remove(const Key: Variant): Boolean; virtual;
    function Rename(const Key, NewKey: Variant): Boolean; virtual;
  ...
  TArray = class(TVariantArray, IVariantArray, IBooleanArray, IIntegerArray, IInt64Array,
    IFloatArray, IDateTimeArray, IStringArray, IPointerArray, IObjectArray, IClassArray)
  private
  ...
  //
    ...
    procedure SetOwnsObjects(const Value: Boolean);
  protected
    procedure FreeItem(var pItem: PVarItem); override;
  public
    property Instance: TArray read GetInstance;
  //property OwnsObjects: Boolean read GetOwnsObjects write SetOwnsObjects;
  end;

  TMultiArray = class(TVariantArray, IMultiArray)
  private
    FValue: Variant;
  //
    function GetAsBoolean: Boolean;
...
function CreateMultiArray: TMultiArray; overload;
function CreateMultiArray(CustomCompare: TVariantCompare): TMultiArray; overload;
...
function CreateMultiArray: TMultiArray;
begin
  Result := TMultiArray.Create;
end;

function CreateMultiArray(CustomCompare: TVariantCompare): TMultiArray;
begin
  Result := TMultiArray.Create(CustomCompare);
end;
...
constructor TVariantArray.Create(CustomCompare: TVariantCompare);
begin
  SetCurrentIndex(-1);
...
function TVariantArray.Exchange(const Key1, Key2: Variant): Boolean;
var
...
function TVariantArray.Exist(const Key: Variant): Boolean;
var
  Index: Integer;
begin
...
function TVariantArray.FindKey(const Key: Variant; var Index: Integer): Boolean;
var
  KeyIndex: Integer;
begin
...
function TVariantArray.FindValue(const Value: Variant; var Index: Integer): Boolean;
var
  L, H, I, C: Integer;
begin
  Result := False;
...
function TVariantArray.Remove(const Key: Variant): Boolean;
var
...
function TVariantArray.Rename(const Key, NewKey: Variant): Boolean;
var
...
procedure TVariantArray.Sort;
begin
  if not FSorted and (FCount > 1) then
    QuickSort(0, FCount - 1);
end;

function TVariantArray.FindInternalKeyIndex(const Key: Variant; var InternalKeyIndex:
  Integer): Boolean;
var
  L, H, I, C: Integer;
begin
...
function TVariantArray.GetInternalValueIndex(InternalKeyIndex: Integer): Integer;
begin
  if FSorted then
...
function TVariantArray.KeyCompare(const Var1, Var2: Variant): Integer;
begin
...
procedure TVariantArray.CreateItem(var pItem: PVarItem);
begin
  New(pItem);
end;

procedure TVariantArray.FreeItem(var pItem: PVarItem);
begin
  Dispose(pItem);
end;
...
procedure TVariantArray.SetCapacity(const Value: Integer);
begin
...
function TVariantArray.GetValue(Index: Integer): Variant;
begin
  if (Index >= 0) and (Index < FCount) then
...
function TVariantArray.GetKey(Index: Integer): Variant;
begin
  if (Index >= 0) and (Index < FCount) then
...
function TVariantArray.GetItem(Key: Variant): Variant;
var
  Index: Integer;
begin
...
procedure TVariantArray.SetItem(Key: Variant; const Value: Variant);
var
...
function TVariantArray.GetBof: Boolean;
begin
  Result := FBof;
end;

function TVariantArray.GetCurrentIndex: Integer;
begin
  Result := FCurrentIndex;
end;

function TVariantArray.GetCurrentKey: Variant;
begin
  Result := GetKey(FCurrentIndex);
end;

function TVariantArray.GetCurrentValue: Variant;
begin
  Result := GetValue(FCurrentIndex);
end;

function TVariantArray.GetEof: Boolean;
begin
  Result := FEof;
end;

procedure TVariantArray.SetCurrentIndex(const Value: Integer);
begin
  FCurrentIndex := Value;
...
procedure TVariantArray.SetSorted(Value: Boolean);
begin
...
function TVariantArray.GetSorted: Boolean;
begin
  Result := FSorted;
end;

procedure TVariantArray.SetKeyCaseSensitive(const Value: Boolean);
begin
  FKeyCaseSensitive := Value;
end;

function TVariantArray.GetKeyCaseSensitive: Boolean;
begin
  Result := FKeyCaseSensitive;
end;

function TVariantArray.GetRefCount: Integer;
begin
  Result := FRefCount;
end;

function TVariantArray.GetCapacity: Integer;
begin
  Result := FCapacity;
end;
...
begin
  if (ExtType(pItem^.Value) = extObject) and FOwnsObjects then
...
function TMultiArray.FindValue(const Value: IMultiArray;
  var Index: Integer): Boolean;
var
  V: Variant;
begin
...
procedure TMultiArray.FreeItem(var pItem: PVarItem);
begin
  if ExtType(pItem^.Value) = extMultiArray then
    TMltData(pItem^.Value).VMultiArray := nil;
  inherited;
end;

function TMultiArray.GetAsBoolean: Boolean;
begin
  Result := FValue;
end;

function TMultiArray.GetAsClass: TClass;
begin
  Result := TClsData(FValue).VClass;
end;

function TMultiArray.GetAsDateTime: TDateTime;
begin
  Result := FValue;
end;

function TMultiArray.GetAsFloat: Double;
begin
  Result := FValue;
end;

function TMultiArray.GetAsInt64: Int64;
begin
  Result := TI64Data(FValue).VInt64;
end;

function TMultiArray.GetAsInteger: Integer;
begin
  Result := FValue;
end;

function TMultiArray.GetAsObject: TObject;
begin
  Result := TObjData(FValue).VObject;
end;

function TMultiArray.GetAsString: string;
begin
  Result := FValue;
end;

function TMultiArray.GetAsVariant: Variant;
begin
  Result := FValue;
end;

function TMultiArray.GetCurrentValue: IMultiArray;
var
  V: Variant;
begin
  ...
  begin
    SetItem(FValues^[FCurrentIndex]^.Key, CreateMultiArray(FValueCompare));
    Result := GetCurrentValue;
  end;
end;

function TMultiArray.GetInstance: TMultiArray;
begin
  Result := Self;
end;

function TMultiArray.GetItem(Key: Variant): IMultiArray;
var
  V: Variant;
begin
  ...
  if not Assigned(Result) then
  begin
    SetItem(Key, CreateMultiArray(FValueCompare));
    Result := GetItem(Key);
  end;
end;

function TMultiArray.GetValue(Index: Integer): IMultiArray;
var
  V: Variant;
begin
  ...
  if not Assigned(Result) then
  begin
    SetItem(FValues^[Index]^.Key, CreateMultiArray(FValueCompare));
    Result := GetValue(Index);
  end;
end;

procedure TMultiArray.SetAsBoolean(const Value: Boolean);
begin
  FValue := Value;
end;

procedure TMultiArray.SetAsClass(const Value: TClass);
begin
  TClsData(FValue).VExtType := extClass;
  TClsData(FValue).VClass := Value;
end;

procedure TMultiArray.SetAsDateTime(const Value: TDateTime);
begin
  FValue := Value;
end;

procedure TMultiArray.SetAsFloat(const Value: Double);
begin
  FValue := Value;
end;

procedure TMultiArray.SetAsInt64(const Value: Int64);
begin
  TI64Data(FValue).VType := varInt64;
  TI64Data(FValue).VInt64 := Value;
end;

procedure TMultiArray.SetAsInteger(const Value: Integer);
begin
  FValue := Value;
end;

procedure TMultiArray.SetAsObject(const Value: TObject);
begin
  TObjData(FValue).VExtType := extObject;
  TObjData(FValue).VObject := Value;
end;

procedure TMultiArray.SetAsString(const Value: string);
begin
  FValue := Value;
end;

procedure TMultiArray.SetAsVariant(const Value: Variant);
begin
  FValue := Value;
end;

procedure TMultiArray.SetItem(Key: Variant; const Value: IMultiArray);
var
  V: Variant;
begin
  V := inherited GetItem(Key);
